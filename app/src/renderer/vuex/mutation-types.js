...
export const REVERSE_ANIMATION = 'REVERSE_ANIMATION'
export const NEW_NOTIFICATION = 'NEW_NOTIFICATION'
export const INCREMENT_VIEW_INDEX = 'INCREMENT_VIEW_INDEX'
export const DECREMENT_VIEW_INDEX = 'DECREMENT_VIEW_INDEX'
